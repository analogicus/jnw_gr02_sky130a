...
VL_INLINE_OPT void Vlng___024root___nba_sequent__TOP__0(Vlng___024root* vlSelf) {
    ...
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Init
    CData/*7:0*/ __Vdly__dig__DOT__counter;
    __Vdly__dig__DOT__counter = 0;
    // Body
    __Vdly__dig__DOT__counter = vlSelfRef.dig__DOT__counter;
    if (vlSelfRef.n_rst) {
        if ((0xffU <= (IData)(vlSelfRef.dig__DOT__counter))) {
            __Vdly__dig__DOT__counter = 0U;
            vlSelfRef.reset = 1U;
        } else {
            __Vdly__dig__DOT__counter = (0xffU & ((IData)(1U) 
                                                  + (IData)(vlSelfRef.dig__DOT__counter)));
            vlSelfRef.reset = 0U;
        }
    } else {
        __Vdly__dig__DOT__counter = 0U;
    ...
    vlSelfRef.dig__DOT__counter = __Vdly__dig__DOT__counter;
}
...
void Vlng___024root___eval_debug_assertions(Vlng___024root* vlSelf) {
    ...
    if (VL_UNLIKELY((vlSelfRef.n_rst & 0xfeU))) {
