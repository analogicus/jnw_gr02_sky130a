...
C {JNW_ATR_SKY130A/JNWATR_PCH_2C1F2.sym} -200 -140 0 0 {name=x1 }
C {JNW_ATR_SKY130A/JNWATR_PCH_2C1F2.sym} 70 -140 0 1 {name=x10 }
C {JNW_ATR_SKY130A/JNWATR_NCH_2C5F0.sym} 170 -40 0 0 {name=x3 }
C {JNW_ATR_SKY130A/JNWATR_NCH_4C5F0.sym} -200 -40 0 0 {name=x4 }
C {JNW_ATR_SKY130A/JNWATR_NCH_2C5F0.sym} -270 -40 0 1 {name=x5 }
C {JNW_ATR_SKY130A/JNWATR_NCH_4C5F0.sym} 70 -40 0 1 {name=x6 }
C {JNW_ATR_SKY130A/JNWATR_PCH_8C5F0.sym} 170 -320 0 0 {name=x7 }
C {JNW_ATR_SKY130A/JNWATR_PCH_4C1F2.sym} -110 -530 0 0 {name=x8[0:1]}
C {JNW_ATR_SKY130A/JNWATR_PCH_4C1F2.sym} -190 -530 0 1 {name=x9 }
C {JNW_ATR_SKY130A/JNWATR_PCH_8C5F0.sym} -270 -320 0 1 {name=x11 }
