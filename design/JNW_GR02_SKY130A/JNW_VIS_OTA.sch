...
C {JNW_ATR_SKY130A/JNWATR_PCH_12C1F2.sym} -200 -140 0 0 {name=xd01[0:3] }
C {JNW_ATR_SKY130A/JNWATR_PCH_12C1F2.sym} 70 -140 0 1 {name=xd02[0:3] }
C {JNW_ATR_SKY130A/JNWATR_NCH_12C5F0.sym} 170 -40 0 0 {name=xc04}
C {JNW_ATR_SKY130A/JNWATR_NCH_12C5F0.sym} -200 -40 0 0 {name=xc02}
C {JNW_ATR_SKY130A/JNWATR_NCH_12C5F0.sym} -270 -40 0 1 {name=xc01}
C {JNW_ATR_SKY130A/JNWATR_NCH_12C5F0.sym} 70 -40 0 1 {name=xc03}
C {JNW_ATR_SKY130A/JNWATR_PCH_12C5F0.sym} 170 -320 0 0 {name=xb02[0:3] }
C {JNW_ATR_SKY130A/JNWATR_PCH_12C5F0.sym} -270 -320 0 1 {name=xb01[0:3] }
C {JNW_TR_SKY130A/JNWTR_RPPO2.sym} -440 -370 1 0 {name=x6}
C {JNW_TR_SKY130A/JNWTR_RPPO2.sym} -440 -270 1 0 {name=x8[0:1]}
C {JNW_ATR_SKY130A/JNWATR_PCH_12C5F0.sym} -190 -840 0 1 {name=xa01}
C {JNW_ATR_SKY130A/JNWATR_PCH_12C5F0.sym} -110 -840 0 0 {name=xa02}
