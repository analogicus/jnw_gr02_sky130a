...
C {JNW_ATR_SKY130A/JNWATR_PCH_12C5F0.sym} 170 -320 0 0 {name=x7 }
C {JNW_ATR_SKY130A/JNWATR_PCH_8C1F2.sym} -110 -530 0 0 {name=x8[0:1]}
C {JNW_ATR_SKY130A/JNWATR_PCH_8C1F2.sym} -190 -530 0 1 {name=x9 }
C {JNW_ATR_SKY130A/JNWATR_PCH_12C5F0.sym} -270 -320 0 1 {name=x11 }
C {JNW_TR_SKY130A/JNWTR_RPPO4.sym} -440 -340 1 0 {name=x2[0]}
C {JNW_TR_SKY130A/JNWTR_RPPO4.sym} -440 -450 1 0 {name=x1[0:3]}
