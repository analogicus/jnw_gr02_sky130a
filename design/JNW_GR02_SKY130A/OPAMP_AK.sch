...
N -210 20 -210 70 {lab=VDD}
N -210 20 -190 20 {lab=VDD}
...
C {JNW_TR_SKY130A/JNWTR_RPPO16.sym} -330 -20 1 0 {name=x13 }
C {JNW_TR_SKY130A/JNWTR_RPPO8.sym} -330 100 1 0 {name=x12 }
C {JNW_ATR_SKY130A/JNWATR_PCH_8C5F0.sym} -150 70 2 0 {name=x4 }
C {JNW_ATR_SKY130A/JNWATR_PCH_4C1F2.sym} -80 -80 2 0 {name=x3 }
C {JNW_ATR_SKY130A/JNWATR_PCH_4C1F2.sym} -20 -80 0 0 {name=x1 }
C {JNW_ATR_SKY130A/JNWATR_PCH_8C5F0.sym} 190 70 0 0 {name=x2 }
C {JNW_ATR_SKY130A/JNWATR_PCH_2C1F2.sym} -110 190 0 0 {name=x11 }
C {JNW_ATR_SKY130A/JNWATR_PCH_2C1F2.sym} 150 190 2 0 {name=x5 }
C {JNW_ATR_SKY130A/JNWATR_NCH_2C5F0.sym} -150 310 0 1 {name=x6 }
C {JNW_ATR_SKY130A/JNWATR_NCH_2C5F0.sym} 190 310 0 0 {name=x9 }
