...
N -460 -390 -440 -390 {lab=#net1}
N -460 -370 -440 -370 {lab=#net1}
N -460 -430 -430 -430 {lab=#net2}
...
N 180 -340 200 -340 {lab=#net3}
N 280 -340 300 -340 {lab=#net4}
N 380 -340 400 -340 {lab=#net5}
N 480 -340 500 -340 {lab=#net6}
N 140 -300 140 -260 {lab=AVSS_INV}
N 140 -260 240 -260 {lab=AVSS_INV}
N 240 -300 240 -260 {lab=AVSS_INV}
N 240 -260 340 -260 {lab=AVSS_INV}
N 340 -300 340 -260 {lab=AVSS_INV}
N 340 -260 440 -260 {lab=AVSS_INV}
N 440 -300 440 -260 {lab=AVSS_INV}
N 440 -260 540 -260 {lab=AVSS_INV}
N 540 -300 540 -260 {lab=AVSS_INV}
N 140 -380 540 -380 {lab=AVDD_INV}
N 60 -180 100 -180 {lab=#net2}
N -210 -180 -180 -180 {lab=VSS}
N -50 -740 -10 -740 {lab=VDD}
N -10 -740 50 -740 {lab=VDD}
N 140 -260 140 -210 {lab=AVSS_INV}
N -120 -240 -120 -180 {lab=#net2}
N -180 -240 -120 -240 {lab=#net2}
...
N -270 -410 -190 -410 {lab=#net2}
N -190 -410 -180 -410 {lab=#net2}
N -180 -410 -180 -210 {lab=#net2}
...
N 190 -270 190 -260 {lab=AVSS_INV}
N 290 -270 290 -260 {lab=AVSS_INV}
N 390 -270 390 -260 {lab=AVSS_INV}
N 490 -270 490 -260 {lab=AVSS_INV}
N 580 -270 580 -260 {lab=AVSS_INV}
N 540 -260 580 -260 {lab=AVSS_INV}
N -340 -410 -270 -410 {lab=#net2}
N -340 -430 -340 -410 {lab=#net2}
N -430 -430 -340 -430 {lab=#net2}
N -440 -390 -440 -370 {lab=#net1}
...
C {JNW_TR_SKY130A/JNWTR_CAPX1.sym} 190 -280 0 0 {name=x7 }
C {JNW_TR_SKY130A/JNWTR_CAPX1.sym} 290 -280 0 0 {name=x15 }
C {JNW_TR_SKY130A/JNWTR_CAPX1.sym} 390 -280 0 0 {name=x16 }
C {JNW_TR_SKY130A/JNWTR_CAPX1.sym} 490 -280 0 0 {name=x17 }
C {JNW_TR_SKY130A/JNWTR_CAPX1.sym} 580 -280 0 0 {name=x18 }
...
C {devices/opin.sym} -440 -410 0 0 {name=p4 lab=VREF
}
C {devices/lab_wire.sym} 140 -230 0 0 {name=p6 sig_type=std_logic lab=AVSS_INV}
C {devices/lab_wire.sym} 220 -380 0 0 {name=p7 sig_type=std_logic lab=AVDD_INV}
