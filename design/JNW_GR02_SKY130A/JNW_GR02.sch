...
C {devices/lab_pin.sym} 1150 -560 0 0 {name=p5 sig_type=std_logic lab=VDD_1V8
}
C {devices/lab_pin.sym} 1150 -420 0 0 {name=p18 sig_type=std_logic lab=CLK}
C {devices/lab_pin.sym} 1150 -340 0 0 {name=p19 sig_type=std_logic lab=VSS
}
C {devices/ipin.sym} 1450 -410 2 0 {name=p20 lab=I_TEMP_OUT8}
C {devices/ipin.sym} 1450 -430 2 0 {name=p21 lab=I_TEMP_OUT7}
C {devices/ipin.sym} 1450 -450 2 0 {name=p22 lab=I_TEMP_OUT6}
C {devices/ipin.sym} 1450 -470 2 0 {name=p23 lab=I_TEMP_OUT5}
C {devices/ipin.sym} 1450 -490 2 0 {name=p24 lab=I_TEMP_OUT4}
C {devices/ipin.sym} 1450 -510 2 0 {name=p25 lab=I_TEMP_OUT3}
C {devices/ipin.sym} 1450 -530 2 0 {name=p26 lab=I_TEMP_OUT2}
C {devices/ipin.sym} 1450 -550 2 0 {name=p27 lab=I_TEMP_OUT1
}
C {JNW_GR02_SKY130A/dig.sym} 1300 -450 0 0 {name=x5}
C {devices/simulator_commands_shown.sym} 1630 -790 0 0 {name=COMMANDS
simulator=ngspice
only_toplevel=false 
value="
